...
(function() {
  angular.module("proximal").controller("ChildrenCtrl", function($log, $cookieStore, $scope) {
...
(function() {
  angular.module("proximal").controller("LibraryCtrl", function($log, $cookieStore, $scope) {
