...
create table "resources" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"title" VARCHAR NOT NULL,"description" Text,"type" VARCHAR,"creator" BIGINT,"created_on" BIGINT);
