...
create table "activities" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"creator" BIGINT NOT NULL,"date" BIGINT NOT NULL,"description" VARCHAR,"rights" VARCHAR,"source" VARCHAR,"subject" VARCHAR,"title" VARCHAR,"category" VARCHAR);
...
create table "activity_sets" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"activity_id" BIGINT NOT NULL,"set_id" BIGINT NOT NULL);
...
create table "scores" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"studentId" BIGINT NOT NULL,"questionId" BIGINT,"actid" BIGINT,"compentency" BIGINT,"timestamp" BIGINT NOT NULL);
