...
create table "activities" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"creator" VARCHAR NOT NULL,"date" BIGINT NOT NULL,"description" VARCHAR,"rights" VARCHAR,"source" VARCHAR,"subject" VARCHAR,"title" VARCHAR,"category" VARCHAR);
...
create table "homework" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"activity_id" BIGINT NOT NULL,"student_id" BIGINT NOT NULL,"teacher_id" BIGINT,"status" VARCHAR NOT NULL,"date_given" BIGINT NOT NULL,"date_due" BIGINT);
...
create table "scores" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"studentId" BIGINT NOT NULL,"questionId" BIGINT NOT NULL,"compentency" INTEGER NOT NULL,"timestamp" BIGINT DEFAULT 1423196189740 NOT NULL);
