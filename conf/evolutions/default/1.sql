...
create table "assesments" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"startDate" BIGINT NOT NULL,"endDate" BIGINT);
create table "assesments_questions_scores" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"question_score_id" BIGINT NOT NULL);
...
create table "scores" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"studentId" BIGINT NOT NULL,"questionId" BIGINT NOT NULL,"compentency" INTEGER NOT NULL,"timestamp" BIGINT DEFAULT 1422120394191 NOT NULL);
