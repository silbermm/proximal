...
create table "activities" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"creator" VARCHAR(254),"date" BIGINT NOT NULL,"description" VARCHAR(254),"rights" VARCHAR(254),"source" VARCHAR(254),"subject" VARCHAR(254),"title" VARCHAR(254),"category" VARCHAR(254));
...
create table "scores" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"studentId" BIGINT NOT NULL,"questionId" BIGINT NOT NULL,"compentency" INTEGER NOT NULL,"timestamp" BIGINT DEFAULT 1423449312121 NOT NULL);
