...
create table "statements" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"standardId" BIGINT NOT NULL,"asn_uri" VARCHAR,"subject" VARCHAR,"notation" VARCHAR,"alternate_notation" VARCHAR,"label" VARCHAR,"description" Text,"alternate_description" Text,"exactMatch" VARCHAR,"identifier" VARCHAR,"language" VARCHAR);
